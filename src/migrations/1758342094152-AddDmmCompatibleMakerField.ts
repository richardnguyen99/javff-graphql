...
export class AddDmmCompatibleMakerField1758342094152
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "maker" ADD "dmm_id" integer NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "maker" ADD CONSTRAINT "UQ_24592cc71bba5824446f4a363ee" UNIQUE ("dmm_id")`
    );
